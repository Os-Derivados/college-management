...
{
    public const string PermissaoGerenciarAdministradores = "Gerenciar Administradores";
    public const string PermissaoGerenciarAlunos = "Gerenciar Alunos";
    public const string PermissaoGerenciarGestores = "Gerenciar Gestores";
